                ...
                return(
                    <div key={item.id}>
                        <div className="tags">
                            ...
                            <span>
                                <i className="fa fa-thumbs-down"></i>{item.likes[1]}
                            </span>
                        </div>
                        <div className="top">
                            <h2>{item.title}</h2>
                        ...
                        <div>
                            <Counter articleId={item.id} section="articles" action="HANDLE_LIKE_ARTICLE" likes={item.likes[0]} dislikes={item.likes[1]}/>    
                        </div>
                    </div>
                )
            })
